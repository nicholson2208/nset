...
//        Serial.print(" qz = "); Serial.println(*(getQ() + 3));
      ...
      int target = 0; //setting target arbitrarily to 0 degrees

      
      
      int lat_vel = 0;
//      for (lat_vel = 0; lat_vel <= myIMU.yaw; lat_vel += 1) {
//        // in steps of 1 degree
//        lateral.write(lat_vel);              // tell servo to go to position in variable 'pos'
